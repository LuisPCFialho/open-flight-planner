...
export function Bussola({ canal, aoApontarANorte }: Props) {
  ...
  return (
    <button
      ...
      title={`Rumo ${Math.round(rumo)}°, inclinação ${Math.round(inclinacao)}° — clica para apontar a norte`}
      aria-label={`Apontar a norte. Rumo actual ${Math.round(rumo)} graus`}
    >
